...
/**
 * http://java.juanluisacebal.com/ACEBAL_RICO_JUANLUIS_AD2_TAREA_APARTADO1.java
 *
 ...
 * además puede servirte profe para ver como lo he ido haciendo,
 * con que he probado y como me ha acabado saliendo
 */

public class ACEBAL_RICO_JUANLUIS_AD2_TAREA_APARTADO1 {
    ...
    public static void main(String[] args) throws Exception {
     ...
     /*   misempleados.add(new Empleados(4, "Jorge","Villarrobledo",  14000.50F, 0.4f));
       ...
       while (archivo.length()>archivo.getFilePointer()) 
       {
        ...
        StreamResult miResult = new StreamResult(new File("prueba.xml"));
